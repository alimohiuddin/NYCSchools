...
//  DMC
//
//  Created by Ali Mohiuddin on 13/01/20.
//  Copyright © 2020 Neuweg. All rights reserved.
//
...
class AJProgressHud {
    static let sharedInstance = AJProgressHud()
    ...
    func show(withTitle title: String?) {
        ...
        if #available(iOS 13.0, *) {
            ...
            subContainer.backgroundColor = UIColor.black
        }
